        ...
        <div className="block md:hidden divide-y divide-slate-200 dark:divide-slate-800">
          {emailLogs.length === 0 ? (
            <div className="p-8 text-center text-xs text-slate-500">
              No hay correos emitidos en el simulador.
            </div>
          ) : (
            emailLogs.map((log) => (
              <div key={log.id} className="p-4 space-y-3">
                ...
                <div className="flex items-center justify-end gap-2 pt-1">
                  <button
                    ...
                    type="button"
                    className="flex-1 sm:flex-initial px-3 py-2 rounded-xl text-xs font-bold btn-primary flex items-center justify-center gap-1.5 shadow-2xs"
                  >
