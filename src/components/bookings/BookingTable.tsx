            ...
            >
              ...
              <div className="flex items-center justify-end gap-2 pt-1">
                <button
                  ...
                  type="button"
                  className="flex-1 sm:flex-initial px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-semibold flex items-center justify-center gap-1.5"
                >
                ...
                {!isCancelled && !isAttended && (
                  <button
                    ...
                    type="button"
                    className="flex-1 sm:flex-initial px-3 py-1.5 rounded-xl text-xs font-bold bg-emerald-500/15 text-emerald-700 dark:text-emerald-300 hover:bg-emerald-500/25 flex items-center justify-center gap-1"
                  >
                ...
                {!isCancelled && (
                  <button
                    ...
                    type="button"
                    className="p-2 rounded-xl text-red-500 hover:bg-red-500/10 border border-transparent hover:border-red-500/20"
