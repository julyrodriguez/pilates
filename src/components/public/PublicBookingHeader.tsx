          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {onOpenMyBookings && (
              ...
              >
                ...
                <span>¿Ya tenés un turno? Consultalo aquí</span>
              </button>
            )}
          </div>
