        ...
        <div className="glass-card p-6 sm:p-8">
          ...
          {currentBooking ? (
            <div className="space-y-4">
              ...
              {(() => {
                const shiftDateTime = new Date(`${currentBooking.shiftDate}T${currentBooking.shiftTime}:00`);
                const diffHours = (shiftDateTime.getTime() - Date.now()) / (1000 * 60 * 60);
                const isUnder3Hours = diffHours < 3;
                  ...
                  return (
                    <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-900 dark:text-amber-200 text-xs space-y-2">
                      <div className="font-bold flex items-center gap-1.5 text-sm text-amber-700 dark:text-amber-400">
                        ...
                        <span>Cancelación Web No Disponible</span>
                      </div>
                      <p className="leading-relaxed">
                        Las cancelaciones automáticas solo pueden realizarse con un mínimo de <strong>3 horas de anticipación</strong>. Para esta clase faltan menos de 3 horas o ya ha comenzado.
                      </p>
                      <p className="text-[11px] text-slate-500 pt-1">
                        Si tienes un inconveniente de fuerza mayor, por favor comunícate directamente con el estudio.
                      </p>
                      <div className="pt-2">
                        <Link
                          href="/reservar"
